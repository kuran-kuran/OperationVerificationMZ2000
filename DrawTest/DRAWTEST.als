...
13A4
13A4                    ; 8255 初期化
13A4    DB E0           	IN	A, (0E0h)
13A6    CB E7           	SET	4, A
13A8    D3 E0           	OUT	(0E0h), A
13AA    3E 82           	LD	A, 082h		; 8255 A=out B=in C=out
13AC    D3 E3           	OUT	(0E3H), A
13AE    3E 58           	LD	A, 058h		; b3:BST=1 b4:OPEN=1 b6:WRITE=1
13B0    D3 E2           	OUT	(0E2H), A
13B2                    ;
13B2                    ; PIO 初期化
13B2                    ;	LD	A, 00Fh		; PIO A=out
13B2                    ;	OUT	(0E9H), A
13B2                    ;	LD	A, 0CFh		; PIO B=in
13B2                    ;	OUT	(0EBH), A
13B2                    ;	LD	A, 0FFh
13B2                    ;	OUT	(0EBH), A
13B2
13B2                    ; テキスト初期化
13B2    3E 50           	LD	A, 80
13B4    CD 5A 1B        	CALL	WIDTH
13B7    CD 86 1B        	CALL	ENABLE_TEXT_VRAM_ADDR
13BA
13BA                    ; テキスト優先、文字色白
13BA    3E 0F           	LD	A, 0Fh
13BC    D3 F5           	OUT	(0F5h), A
13BE                    ; 背景色黒
13BE    3E 00           	LD	A, 0
13C0    D3 F4           	OUT	(0F4h), A
13C2
13C2                    ; テキストクリア
13C2    CD 99 1C        	CALL	CLS
13C5
13C5                    ; 左上指定
13C5    11 00 00        	LD	DE, 0
13C8    CD 9C 1B        	CALL	CURSOR
13CB
13CB                    ; メッセージ表示
13CB    21 23 25        	LD	HL, MSG
13CE    CD 1E 1C        	CALL	PRINT_MSG
13D1
13D1                    ; 改行
